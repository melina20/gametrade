        ...
        <div class="group_breadcrumb">
          <div id="breadcrumb" class="row breadcrumb">
            <div class="col-md-24">
              ...
              <span class="page-title">Playstation 1</span>
            </div>
          </div>
        </div>
          ...
          <div id="col-main" class="collection collection-page col-content col-md-19">
            ...
            <div id="page-header">
              <div class="row text-center">
                <h4 id="page-title">Games for Playstation 1</h4>
            ...
            <div id="sandBox-wrapper">
              <ul id="sandBox" class="list-unstyled row isotope">
                  <?php foreach ($this->playstation1games as $ps1game): ?>
                <li class="element">
                    <ul class="row-container list-unstyled clearfix">
                      <li class="row-left">
                        <a href="./product.html" class="hoverBorder">
                          <span class="hoverBorderWrapper">
                            <img style="width:152px;height:216px;" src="<?= base_url($ps1game['image']); ?>" class="image-fly img-responsive" alt="<?= $ps1game['gamename'];?>">
                          </span>
                      ...
                      <li class="row-right text-left parent-fly animMix">
                        <div class="group_info">
                          <a class="title-5" href="#"><?= $ps1game['gamename'];?></a>
                          <br>
            ...
            <div class="pagination title-3 clearfix">
              <div class="col-md-8 text-left"><?php echo count($this->playstation1games);?> ITEMS </div>
